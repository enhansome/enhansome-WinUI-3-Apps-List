...
<p align="center">
  <a href="https://fluentdeck.vercel.app/apps">
    <span style="display:inline-block;"><strong><u>Browse the WinUI Apps Directory on Fluentdeck</u></strong></span>
  </a>
</p>
  ...
  <li>
    <details open>
      ...
      <ul>
        ...
        <li>🧑‍💻 <a href="#%E2%80%8D-developer-tools">Developer Tools</a></li>
        <li>
          <details>
            <summary>⬇️ <a href="#%EF%B8%8F-download-managers">Download Managers</a></summary>
            <ul>
              <li><a href="#full-featured-download-manager">Full-Featured Download Manager</a></li>
              <li><a href="#torrenting">Torrenting</a></li>
        ...
        <li>💵 <a href="#%EF%B8%8F-finance">Finance</a></li>
        <li>
          <details>
        ...
        <li>🙎‍♂️ <a href="#%E2%80%8D%EF%B8%8F-lifestyle">Lifestyle</a></li>
        <li>
          <details>
            <summary>🎬 <a href="#-media">Media</a></summary>
            <ul>
              <li>
                <details>
                  <summary>🖼️ <a href="#%EF%B8%8F-images">Images</a></summary>
                  <ul>
              ...
              <li>
                <details>
                  <summary>🎧 <a href="#-music">Music</a></summary>
                  <ul>
              ...
              <li>
                <details>
                  <summary>📄 <a href="#-documents">Documents</a></summary>
                  <ul>
              ...
              <li>🎙️ <a href="#%EF%B8%8F-podcasts">Podcasts</a></li>
              <li>
                <details>
                  <summary>🎬 <a href="#-video">Video</a></summary>
                  <ul>
                    <li><a href="#players-1">Players</a></li>
                    <li><a href="#streaming">Streaming</a></li>
                    <li><a href="#tracking">Tracking</a></li>
                    <li><a href="#live-tv--iptv">Live TV &amp; IPTV</a></li>
        ...
        <li>💠 <a href="#-multimedia--design">Multimedia &amp; Design</a></li>
        ...
        <li>
          <details>
            ...
            <ul>
              <li><a href="#2fa-authenticator">2FA Authenticator</a></li>
        ...
        <li>
          <details>
            <summary>💻 <a href="#-system">System</a></summary>
            <ul>
...
* `WDM` [Files App](https://github.com/files-community/files) ⭐ 44,609 | 🐛 464 | 🌐 C# | 📅 2026-08-12
* `WDM` [Ambie](https://github.com/jenius-apps/ambie) ⭐ 2,223 | 🐛 44 | 🌐 C# | 📅 2026-08-06 <sup>`FOSS`</sup>
* `WDM` [Melora](https://github.com/IcySnex/Melora) ⭐ 61 | 🐛 1 | 🌐 C# | 📅 2026-07-31 <sup>`FOSS`</sup>
* `WDM` [Fluent Emoji Gallery](https://github.com/michalleptuch/fluent-emoji-gallery) ⭐ 45 | 🐛 8 | 📅 2024-10-20
* `WDM` [Odyssey](https://github.com/deadwood2/OdysseyWebBrowser) ⭐ 43 | 🐛 8 | 🌐 C++ | 📅 2025-06-26
...
# Awesome 📑 Apps List with stars

## 🆕 Newly Added Apps!

Last 17 apps that were recently added to list!

* `WDM` [Raven](https://github.com/mjishnu/Raven) ⭐ 236 | 🐛 4 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WD` [Task Scheduler Studio](https://github.com/MarkHopper24/Task-Scheduler-Studio) ⭐ 13 | 🐛 0 | 🌐 C# | 📅 2026-08-06 <sup>`FOSS`</sup>
* `WDM` [MdPad](https://github.com/radueduard97/MdPad) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2026-07-25 <sup>`FOSS`</sup>
* `WD` [D3D12LookDevPTWinUI](https://github.com/shaderjp/D3D12LookDevPTWinUI3) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-08-08 `📆 Planned` <sup>`FOSS`</sup>
* `WDA` [Linkscape](https://github.com/JohnDizzle/Linkscape) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 <sup>`FOSS`</sup>
...
* `WDM` [UniGetUI](https://github.com/Devolutions/UniGetUI) ⭐ 25,505 | 🐛 459 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WDA` [FluentStore](https://github.com/yoshiask/FluentStore) ⭐ 546 | 🐛 25 | 🌐 C# | 📅 2026-02-19 <sup>`FOSS`</sup>
* `WDM` [Raven](https://github.com/mjishnu/Raven) ⭐ 236 | 🐛 4 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
...
* `WDM` [OpenClaw Windows Hub](https://github.com/openclaw/openclaw-windows-node) ⭐ 2,045 | 🐛 85 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Rodel Agent](https://github.com/Richasy/Rodel.Agent) ⭐ 395 | 🐛 17 | 🌐 C# | 📅 2025-10-16 <sup>`FOSS`</sup>
* `WDA` [GitHub Copilot Taskbar GUI](https://github.com/sirredbeard/ghcopilot-taskbar-gui) ⚠️ Archived <sup>`FOSS`</sup>
* `WDM` [Rodel Downloader](https://github.com/Richasy/Rodel.Downloader) ⭐ 110 | 🐛 1 | 🌐 C# | 📅 2024-05-10 <sup>`FOSS`</sup>
* `WDM` [NAI Utility Tool](https://github.com/Aeka0/NAI-Utility-Tool) ⭐ 53 | 🐛 0 | 🌐 C# | 📅 2026-07-31 <sup>`FOSS`</sup>
* `WD` [GPT Labs](https://github.com/mnikonov/gpt-labs) ⭐ 46 | 🐛 14 | 🌐 C# | 📅 2025-01-12
* `WD` [Verdure Assistant](https://github.com/maker-community/Verdure.Assistant) ⭐ 40 | 🐛 0 | 🌐 C# | 📅 2026-05-23 <sup>`FOSS`</sup>
* `WD` [CodexBarWin](https://github.com/nek0der/CodexBarWin) ⭐ 22 | 🐛 2 | 🌐 C# | 📅 2026-08-13 <sup>`FOSS`</sup>
* `WDM` [KaiROS AI](https://github.com/avikeid2007/KaiROS-AI) ⭐ 19 | 🐛 22 | 🌐 C# | 📅 2026-06-27 <sup>`FOSS`</sup>
...
* `WDM` [ChatGPT Desktop App](https://github.com/johngagefaulkner/ChatGPTDesktopApp) ⭐ 8 | 🐛 0 | 🌐 C# | 📅 2026-06-21 `📆` <sup>`FOSS`</sup>
* `WDM` [BigChat](https://github.com/Sammy-Lastre/BigChat) ⭐ 5 | 🐛 0 | 🌐 C# | 📅 2026-04-03 <sup>`FOSS`</sup>
* `WD` [TLAH Studio](https://github.com/24373054/TLAH-Studio) ⭐ 4 | 🐛 4 | 🌐 C# | 📅 2026-08-02 <sup>`FOSS`</sup>
* `WD` [AiLogAnalyzer](https://github.com/smartzan63/AiLogAnalyzer) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2024-12-02 <sup>`FOSS`</sup>
* `WD` [CodexBar](https://github.com/dontcallmejames/CodexBar-Windows) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-07-13 <sup>`FOSS`</sup>
* `WD` [Lucky](https://github.com/Guts444/Lucky) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-07-13 <sup>`FOSS`</sup>
* `WD` [Romanowsky Stain Slide Analyzer](https://github.com/h-ch22/RomanowskyStainSlideAnalyzer_Windows) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-03-24 <sup>`FOSS`</sup>
* `WD` [WhisperShroom](https://github.com/shroomlife/whisper-shroom) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-08-03 <sup>`FOSS`</sup>
...
* `WDM` [Yukari - Comic Manager/Reader](https://github.com/Yukari-App/Yukari) ⭐ 35 | 🐛 0 | 🌐 C# | 📅 2026-08-13 <sup>`FOSS`</sup>

<sub>[📑 Table Of Contents](#-table-of-contents)</sub>

## 💼 Business

* `WDA` [Prosthetics Store Admin App](https://github.com/amkhrjee/proshandadmin) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2024-05-23 <sup>`FOSS`</sup>
* `WD` [WINUI3 Book Management System](https://github.com/Sandersshine/WINUI3_BOOKMS) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2024-06-14 <sup>`FOSS`</sup>
* `WD` [SuperPOS](https://apps.microsoft.com/detail/9nqgzwxw33xq)

## 🌐 Browser

* `WDA` [Hurl](https://github.com/U-C-S/Hurl) ⭐ 454 | 🐛 40 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WDM` [Firefox-WinUI](https://github.com/Lockframe/Firefox-WinUI) ⭐ 163 | 🐛 12 | 🌐 CSS | 📅 2026-07-24 `🎨` <sup>`FOSS`</sup>
* `WDM` [Odyssey](https://github.com/deadwood2/OdysseyWebBrowser) ⭐ 43 | 🐛 8 | 🌐 C++ | 📅 2025-06-26 `📆` <sup>`FOSS`</sup>
...
* `WDM` [Windows Community Toolkit](https://github.com/CommunityToolkit/Windows) ⭐ 1,043 | 🐛 234 | 🌐 C# | 📅 2026-08-04 <sup>`FOSS`</sup>
* `WD` [Qt-Fluent-Widgets](https://github.com/Fairy-Oracle-Sanctuary/Qt-Fluent-Widgets) ⭐ 52 | 🐛 2 | 🌐 C++ | 📅 2026-07-13 <sup>`FOSS`</sup>
...
* `WDM` [AI Dev Gallery](https://apps.microsoft.com/detail/9n9pn1mm3bd5) <sup>`FOSS`</sup>
* `WD` [DevWinUI Gallery](https://apps.microsoft.com/detail/DevWinUI%20Gallery%20App/9nmx5x5dlsrq)
...
* `WD` [WinUI 3 Gallery](https://apps.microsoft.com/store/detail/winui-3-gallery/9P3JFPWWDZRC) <sup>`FOSS`</sup>
* `WDM` [WinUIEssentials.WinUI3Example](https://apps.microsoft.com/detail/9pcc690bcmt9)
* `WDM` [WPF Gallery](https://apps.microsoft.com/detail/9ndlx60wx4kq)
* `WDM` [WPF UI](https://apps.microsoft.com/store/detail/wpf-ui/9N9LKV8R9VGM)

## 🧑‍💻 Developer Tools

* `WD` [DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,854 | 🐛 337 | 🌐 C# | 📅 2026-02-25 <sup>`FOSS`</sup>
* `WDM` [PyQt Fluent Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ⭐ 8,065 | 🐛 22 | 🌐 Python | 📅 2026-08-01 <sup>`FOSS`</sup>
* `WDM` [Rectify11](https://github.com/Rectify11/Installer) ⭐ 3,481 | 🐛 150 | 🌐 JavaScript | 📅 2026-01-05 <sup>`FOSS`</sup>
* `WDM` [Sun Valley ttk theme](https://github.com/rdbende/Sun-Valley-ttk-theme) ⭐ 2,572 | 🐛 37 | 🌐 Tcl | 📅 2025-06-08 <sup>`FOSS`</sup>
* `WD` [FluentHub](https://github.com/0x5bfa/FluentHub) ⭐ 1,250 | 🐛 37 | 🌐 C# | 📅 2026-07-29 <sup>`FOSS`</sup>
* `WD` [QTWin11](https://github.com/witalihirsch/QTWin11) ⭐ 375 | 🐛 3 | 🌐 Python | 📅 2022-08-24 <sup>`FOSS`</sup>
* `WD` [DevWinUI](https://github.com/ghost1372/DevWinUI) ⭐ 321 | 🐛 1 | 🌐 C# | 📅 2026-08-09
* `WDM` [Loopback Manager](https://github.com/Richasy/LoopbackManager.Desktop) ⭐ 259 | 🐛 1 | 🌐 C# | 📅 2026-07-16 <sup>`FOSS`</sup>
* `WD` [Fellmonger](https://github.com/fbarbat/fellmonger) ⭐ 201 | 🐛 0 | 🌐 Swift | 📅 2024-09-09 <sup>`FOSS`</sup>
* `WD` [JitHub](https://github.com/JitHubApp/JitHubV2) ⭐ 152 | 🐛 7 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WD` [Azure Key Vault Explorer](https://github.com/cricketthomas/AzureKeyVaultExplorer) ⭐ 115 | 🐛 15 | 🌐 C# | 📅 2026-08-09
* `WD` [PreLaunchTaskr](https://github.com/SuGar0218/PreLaunchTaskr) ⭐ 54 | 🐛 0 | 🌐 C# | 📅 2025-06-27 <sup>`FOSS`</sup>
* `WD` [AK.Toolkit](https://github.com/AndrewKeepCoding/AK.Toolkit) ⭐ 52 | 🐛 2 | 🌐 C# | 📅 2026-02-02 <sup>`FOSS`</sup>
...
* `WDM` [Hakonexa](https://github.com/runceel/wsl-containers-desktop) ⭐ 11 | 🐛 0 | 🌐 C# | 📅 2026-07-17 <sup>`FOSS`</sup>
* `WD` [Grex](https://github.com/visorcraft/Grex) ⭐ 10 | 🐛 0 | 🌐 C# | 📅 2026-07-28 <sup>`FOSS`</sup>
* `WDM` [Sandboxer](https://github.com/Slluxx/Sandboxer) ⭐ 10 | 🐛 0 | 🌐 C# | 📅 2024-06-23 <sup>`FOSS`</sup>
* `WD` [HexBox.WinUI](https://github.com/hotkidfamily/HexBox.WinUI) ⭐ 9 | 🐛 1 | 🌐 C# | 📅 2026-07-14 <sup>`FOSS`</sup>
* `WDM` [ReCaptcha.Desktop](https://github.com/IcySnex/ReCaptcha.Desktop) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2024-10-03 <sup>`FOSS`</sup>
* `WDM` [IconExtractor](https://github.com/GuildOfCalamity/IconExtractor) ⭐ 6 | 🐛 1 | 🌐 C# | 📅 2024-07-02 <sup>`FOSS`</sup>
* `WDM` [Colors.Rainbow](https://github.com/sh0ckj0ckey/Colors.Rainbow) ⭐ 5 | 🐛 0 | 🌐 C# | 📅 2026-06-18 <sup>`FOSS`</sup>
* `WD` [FlarePurge](https://github.com/colorvivo/flarepurge-windows) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-07-10 <sup>`FOSS`</sup>
* `WD` [KeyPocket](https://github.com/MidnightCrowing/KeyPocket) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2026-02-14 <sup>`FOSS`</sup>
* `WD` [CFTools for Windows](https://github.com/investblog/cftools-win) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-03-24 <sup>`FOSS`</sup>
* `WD` [gclo - Git Clone Large Organizations](https://github.com/KofTwentyTwo/gclo) ⭐ 0 | 🐛 17 | 🌐 C# | 📅 2026-07-20 <sup>`FOSS`</sup>
* `WDM` [RetroC IDE](https://github.com/avikeid2007/Retro-C-IDE) ⭐ 0 | 🐛 0 | 🌐 C | 📅 2026-04-11 <sup>`FOSS`</sup>
...
* `WDM` [WinAsset Studio – WinUI Asset Generator](https://apps.microsoft.com/detail/9pc5wlm83nx7)
* `WDM` [WinUI 2 Gallery](https://apps.microsoft.com/detail/9msvh128x2zt)
...
* `WDM` [Ghost Downloader](https://github.com/XiaoYouChR/Ghost-Downloader-3) ⭐ 8,241 | 🐛 58 | 🌐 Python | 📅 2026-08-12 `📆` <sup>`FOSS`</sup> (Based on [PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ⭐ 8,065 | 🐛 22 | 🌐 Python | 📅 2026-08-01, not WinUI)
* `WDM` [OnionMedia](https://github.com/onionware-github/OnionMedia) ⭐ 358 | 🐛 29 | 🌐 C# | 📅 2026-06-01 <sup>`FOSS`</sup>
...
* `WDM` [qBitTorrent-Fluent theme](https://github.com/witalihirsch/qBitTorrent-fluent-theme) ⭐ 1,270 | 🐛 13 | 🌐 Python | 📅 2024-11-05 <sup>`FOSS`</sup>
* `WDM` [WinTorrent](https://apps.microsoft.com/detail/9nq9vf309dn6)
* `WDM` [youTorrent](https://apps.microsoft.com/detail/9p2qmbvqrcfn)

### YouTube

* `WDM` [WinTube](https://github.com/Areoxy/WinTube) ⭐ 6 | 🐛 0 | 📅 2026-05-14 <sup>`FOSS`</sup>
* `WD` [YT2MP3](https://github.com/0zean/YT2MP3) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2024-09-16 <sup>`FOSS`</sup>
* `WD` [TubeSync](https://github.com/manusoft/youtube-downloader-desktop) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2024-12-28 <sup>`FOSS`</sup>
* `WDA` [FluentDownloader](https://github.com/kirrishima/FluentDownloader) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2025-10-16 <sup>`FOSS`</sup>
* `WDM` [MermaYT](https://github.com/laura-kolcavova/MermaYT) ⭐ 1 | 🐛 1 | 🌐 C# | 📅 2026-07-24 <sup>`FOSS`</sup>
* `WDM` `WDA` [Lech YT-DLP](https://apps.microsoft.com/detail/9N28HRK3320G) <sup>`FOSS`</sup>
...
* `WDM` [Parabolic](https://github.com/NickvisionApps/Parabolic) ⭐ 6,832 | 🐛 85 | 🌐 C# | 📅 2026-06-29 <sup>`FOSS`</sup>
...
* `WDM` [Typing 365 | Daily Typing Trainer](https://apps.microsoft.com/detail/9nd9jrkt3f16)
* `WDM` [WTHIT](https://github.com/SaberCris24/WTHIT) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2025-11-01 <sup>`FOSS`</sup>
* `WD` [Zhouyi.WinUI3](https://apps.microsoft.com/detail/9nnxf2qhf21j)

## 📧 Email

* `WDM` [Wino Mail](https://github.com/bkaankose/Wino-Mail) ⭐ 1,555 | 🐛 149 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Eppie Mail](https://github.com/Eppie-io/Eppie-App) ⭐ 408 | 🐛 61 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
...
* `WDM` [Files App](https://github.com/files-community/files) ⭐ 44,609 | 🐛 464 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
...
* `WDM` [BitWallpaper](https://github.com/torum/BitWallpaper) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2026-04-29 <sup>`FOSS`</sup>
* `WD` [earmark](https://github.com/williamckha/earmark) ⭐ 4 | 🐛 1 | 🌐 C# | 📅 2023-08-01 `📅 Planned` <sup>`FOSS`</sup>
* `WD` [MyMoney](https://github.com/jm6271/MyMoney) ⭐ 2 | 🐛 6 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WDA` [Stock Watcher - WidBar Widget](https://apps.microsoft.com/detail/9mwk4x22ql4m)
...
* `WDM` [Emerald](https://github.com/RiversideValley/Emerald) ⭐ 79 | 🐛 10 | 🌐 C# | 📅 2026-07-06 <sup>`FOSS`</sup>
...
* `WDM` [MineSweeperino](https://github.com/NydusBorn/MineSweeperino) ⚠️ Archived <sup>`FOSS`</sup> `❎`
...
* `WDM` [Bloxstrap](https://github.com/bloxstraplabs/bloxstrap) ⭐ 3,098 | 🐛 1,342 | 🌐 C# | 📅 2026-08-05 <sup>`FOSS`</sup>
* `WDA` [Collapse](https://github.com/CollapseLauncher/Collapse) ⭐ 1,771 | 🐛 40 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Handheld Companion](https://github.com/Valkirie/HandheldCompanion) ⭐ 1,695 | 🐛 335 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WDA` [Natsurainko.FluentLauncher](https://github.com/Xcube-Studio/Natsurainko.FluentLauncher) ⭐ 424 | 🐛 15 | 🌐 C# | 📅 2026-03-21 <sup>`FOSS`</sup>
* `WD` [OmniConsole](https://github.com/8bit2qubit/OmniConsole) ⭐ 269 | 🐛 0 | 🌐 C# | 📅 2026-08-02 <sup>`FOSS`</sup>
* `WD` [OVR Lighthouse Manager](https://github.com/kurotu/OVR-Lighthouse-Manager) ⭐ 182 | 🐛 8 | 🌐 C# | 📅 2025-07-12 <sup>`FOSS`</sup>
* `WDM` [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 112 | 🐛 6 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [New Eden Roaming Guide](https://github.com/qedsd/TheGuideToTheNewEden) ⭐ 85 | 🐛 8 | 🌐 C# | 📅 2026-08-07 <sup>`FOSS`</sup>
* `WDA` [Vanilla-RTX-App](https://github.com/Cubeir/Vanilla-RTX-App) ⭐ 78 | 🐛 0 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WDM` [Dotahold](https://github.com/sh0ckj0ckey/Dotahold) ⭐ 41 | 🐛 0 | 🌐 C# | 📅 2026-04-11 <sup>`FOSS`</sup>
* `WD` [ky3-Launcher](https://github.com/ky3-studio/ky3-Launcher) ⭐ 29 | 🐛 0 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Citrine](https://github.com/CitrineLauncher/Citrine) ⭐ 26 | 🐛 3 | 🌐 C++ | 📅 2026-08-11 <sup>`FOSS`</sup>
...
* `WD` [GenshinSwitch](https://github.com/GenshinMatrix/genshin-switch) ⚠️ Archived <sup>`FOSS`</sup> `❎`
* `WD` [AoE2DE Lobby Browser](https://github.com/tmk907/AoE2DELobbyBrowser) ⭐ 8 | 🐛 0 | 🌐 C# | 📅 2026-04-09 <sup>`FOSS`</sup>
* `WD` [SteamPulse](https://github.com/AmirMahdaviAM/SteamPulse) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2024-08-30 <sup>`FOSS`</sup>
* `WDM` [BallanceLauncher](https://github.com/Ghomist/BallanceLauncher) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2022-09-24 <sup>`FOSS`</sup>
* `WD` [GameGate](https://github.com/akoc1/GameGate) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2025-12-23 <sup>`FOSS`</sup>
* `WD` [Steam Achievements](https://github.com/pepeizq/Steam-Achievements) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2024-06-19 <sup>`FOSS`</sup>
* `WD` [Versatile](https://github.com/VersatileProject/Versatile) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2023-11-06 <sup>`FOSS`</sup>
...
* `WDM` [Image Viewer](https://github.com/dragonofmercy/image-viewer) ⭐ 65 | 🐛 1 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
...
* `WDM` [ArtWork](https://github.com/ghost1372/ArtWork) ⭐ 15 | 🐛 0 | 🌐 C# | 📅 2025-08-02 <sup>`FOSS`</sup>
* `WD` [AT-Image-Converter](https://github.com/airtaxi/AT-Image-Converter) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2026-07-25 <sup>`FOSS`</sup>
* `WD` [ImageRate](https://github.com/fm-sys/ImageRate) ⭐ 3 | 🐛 2 | 🌐 C# | 📅 2024-11-10 <sup>`FOSS`</sup>
* `WD` [Video Splitter](https://github.com/PeteJobi/VideoSplitter) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-01-24 <sup>`FOSS`</sup>
* `WD` [MetadataApp](https://github.com/t-manojkumar/MetadataApp) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2025-08-01 <sup>`FOSS`</sup>
...
* `WDM` [Untamed Music Player](https://github.com/LanZhan-Harmony/WindowsMusicPlayer-TheUntamedMusicPlayer) ⭐ 227 | 🐛 18 | 🌐 C# | 📅 2026-07-05 <sup>`FOSS`</sup>
* `WD` [Trdo](https://github.com/TheJoeFin/Trdo) ⭐ 170 | 🐛 22 | 🌐 C# | 📅 2026-08-08 <sup>`FOSS`</sup>
* `WDM` [Stylophone](https://github.com/Difegue/Stylophone) ⭐ 159 | 🐛 17 | 🌐 C# | 📅 2026-06-12 <sup>`FOSS`</sup>
* `WDM` [Strix Music](https://github.com/Arlodotexe/strix-music) ⭐ 150 | 🐛 41 | 🌐 C# | 📅 2026-05-19 <sup>`FOSS`</sup>
...
* `WDM` [Musium](https://github.com/paste1ess/Musium) ⭐ 16 | 🐛 0 | 🌐 C# | 📅 2026-05-26 <sup>`FOSS`</sup>
* `WDM` [OpenDeezer](https://github.com/Cycl0o0/OpenDeezer) ⭐ 6 | 🐛 6 | 🌐 Go | 📅 2026-07-18 <sup>`FOSS`</sup>
* `WD` [BarPlay](https://github.com/airtaxi/BarPlay) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-08-04 <sup>`FOSS`</sup>
* `WDM` [Sound Reaver](https://github.com/sungaila/SoundReaver) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-07-08 <sup>`FOSS`</sup>
* `WDM` [haikusMediaPlayer](https://github.com/nebula-neru/haikusMediaPlayer) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2024-03-19 <sup>`FOSS`</sup>
* `WD` [Folderity](https://github.com/Shailosingh/Folderity) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2023-11-05 `📆 Planned` <sup>`FOSS`</sup>
* `WDM` [Tid3](https://github.com/ArthurCarrenho/Tid3) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-04-05 <sup>`FOSS`</sup>
* `WDM` [Rhythm](https://github.com/FallenDeity/Rhythm) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2024-04-25 <sup>`FOSS`</sup>
* `WDM` [Fluent Metronome](https://apps.microsoft.com/detail/9pnnnts5jmtp)
* `WDM` [Melosik](https://apps.microsoft.com/store/detail/melosik-music-player-for-windows/9NH759PMH26M)
* `WDA` [Music-M](https://github.com/MaKrotos/Music-M) <sup>`FOSS`</sup>
...
* `WDM` [Quick Media Controls](https://apps.microsoft.com/detail/9msq5ct443tv)
...
* `WDM` [WaveeMusic](https://github.com/christosk92/WaveeMusic) ⭐ 45 | 🐛 5 | 🌐 C# | 📅 2026-08-01 <sup>`FOSS`</sup>
...
* `WDM` [Rune](https://github.com/DanialJaved/rune) ⭐ 5 | 🐛 1 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WD` [Glance PDF](https://github.com/jonas1ara/Glance) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-07-08 <sup>`FOSS`</sup>
...
* `WD` [MegaPDF](https://github.com/SlyWombat/MegaPDF) ⭐ 0 | 🐛 22 | 🌐 C | 📅 2026-08-13 <sup>`FOSS`</sup>
...
* `WDM` [Screenbox](https://github.com/huynhsontung/Screenbox/) ⭐ 4,052 | 🐛 227 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Rise Media Player](https://github.com/theimpactfulcompany/Rise-Media-Player) ⭐ 1,222 | 🐛 54 | 🌐 C# | 📅 2025-10-23 <sup>`FOSS`</sup>
* `WD` [Danmaku Player](https://github.com/Poker-sang/DanmakuPlayer) ⭐ 39 | 🐛 0 | 🌐 C# | 📅 2026-05-19 <sup>`FOSS`</sup>
* `WDM` [Awesome Media Player WinUI3](https://github.com/bluday/awesome-media-player) ⭐ 33 | 🐛 0 | 🌐 C# | 📅 2026-07-26 `📆` <sup>`FOSS`</sup>
* `WD` [JasperMediaPlayer](https://github.com/JasperSoosaar25/JasperMediaPlayer) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-06-16 <sup>`FOSS`</sup>
...
* `WDM` [HyPlayer](https://github.com/HyPlayer/HyPlayer) ⭐ 1,426 | 🐛 63 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDA` [FluentFin](https://github.com/insomniachi/FluentFin) ⭐ 99 | 🐛 10 | 🌐 C# | 📅 2026-08-05
...
* `WDM` [Bili.Copilot](https://github.com/Richasy/Bili.Copilot) ⭐ 5,226 | 🐛 267 | 🌐 GLSL | 📅 2025-11-26 <sup>`FOSS`</sup>
* `WDM` [BiliLite](https://github.com/ywmoyue/biliuwp-lite) ⭐ 1,096 | 🐛 102 | 🌐 C# | 📅 2026-08-08 <sup>`FOSS`</sup>
* `WDM` [Totoro](https://github.com/insomniachi/Totoro) ⭐ 285 | 🐛 15 | 🌐 C# | 📅 2025-05-27 <sup>`FOSS`</sup>
* `WDM` [AniMoe](https://github.com/CosmicPredator/AniMoe) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2026-06-02 <sup>`FOSS`</sup>
...
* `WD` [VideoCropper](https://github.com/PeteJobi/VideoCropper) ⭐ 1 | 🐛 2 | 🌐 C# | 📅 2026-04-08 <sup>`FOSS`</sup>

<sub>[📑 Table Of Contents](#-table-of-contents)</sub>

## 💠 Multimedia & Design

* `WDM` [Character Map UWP](https://github.com/character-map-uwp/Character-Map-UWP) ⭐ 783 | 🐛 13 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WD` [Unpaint](https://github.com/axodox/unpaint) ⭐ 285 | 🐛 16 | 🌐 C++ | 📅 2024-04-14 <sup>`FOSS`</sup>
* `WDM` [Fluent Emoji Gallery](https://github.com/michalleptuch/fluent-emoji-gallery) ⭐ 45 | 🐛 8 | 📅 2024-10-20 <sup>`FOSS`</sup>
* `WDM` [Fluent Noise Generator](https://github.com/bluday/fluent-noise-generator) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2026-07-27 <sup>`FOSS`</sup>
* `WD` [Painto](https://github.com/BradleyBao/Painto) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2025-12-23 <sup>`FOSS`</sup>
* `WDM` [Summer](https://github.com/sh0ckj0ckey/Summer) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2026-06-08 <sup>`FOSS`</sup>
...
* `WDM` [Fluent Feeds](https://github.com/hannesschulze/fluent-feeds) ⭐ 41 | 🐛 11 | 🌐 C# | 📅 2022-08-28 <sup>`FOSS`</sup>
* `WD` [FeedDesk](https://github.com/torum/FeedDesk) ⭐ 23 | 🐛 4 | 🌐 C# | 📅 2026-07-23 <sup>`FOSS`</sup>
* `WD` [PocketReader](https://github.com/aungkokomm/PocketReader) ⭐ 8 | 🐛 0 | 🌐 C# | 📅 2026-06-28 <sup>`FOSS`</sup>
...
* `WD` [Ink Canvas Artistry](https://github.com/InkCanvas/Ink-Canvas-Artistry) ⭐ 93 | 🐛 16 | 🌐 C# | 📅 2025-07-31 <sup>`FOSS`</sup>
* `WDM` [FlowBoard](https://github.com/FireCubeStudios/FlowBoard/tree/master/FlowBoard) ⭐ 13 | 🐛 2 | 🌐 C# | 📅 2022-10-04 <sup>`FOSS`</sup>

### Notes

* `WDM` [Typedown](https://github.com/byxiaozhi/Typedown) ⭐ 1,045 | 🐛 74 | 🌐 JavaScript | 📅 2025-09-05 <sup>`FOSS`</sup>
* `WDM` [UltraPad](https://github.com/lixkote/ultrapad) ⭐ 370 | 🐛 6 | 🌐 C | 📅 2026-05-05 <sup>`FOSS`</sup>
* `WDM` [Storylines](https://github.com/morning4coffe-dev/storylines) ⭐ 92 | 🐛 5 | 🌐 C# | 📅 2026-07-25 <sup>`FOSS`</sup>
...
* `WDM` `WDA` [MyNotes](https://github.com/Erencrypt/MyNotes) ⭐ 28 | 🐛 0 | 🌐 C# | 📅 2025-10-16 <sup>`FOSS`</sup>
...
* `WDM` [Ivirius Text Editor](https://github.com/IviriusMain/Ivirius-Text-Editor) ⭐ 9 | 🐛 14 | 📅 2025-08-10 <sup>`FOSS`</sup>
* `WD` [InkMD-Editor](https://github.com/tribeti/InkMD-Editor) ⭐ 6 | 🐛 1 | 🌐 C# | 📅 2026-08-06 <sup>`FOSS`</sup>
* `WDM` [MdPad](https://github.com/radueduard97/MdPad) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2026-07-25 <sup>`FOSS`</sup>
* `WD` [Ideas](https://github.com/living-ming/WinUI3-Ideas) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2025-08-29 <sup>`FOSS`</sup>
* `WD` [Markdown Viewer](https://github.com/sannlynnhtun-coding/markdown-viewer-app) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-07-02 <sup>`FOSS`</sup>
* `WD` [WinMD](https://github.com/toevi/WinMD) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WD` [Tideline](https://github.com/BENZOOgataga/Tideline) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-05-24 <sup>`FOSS`</sup>
...
* `WDM` [TaskList](https://github.com/GuildOfCalamity/TaskList) ⭐ 13 | 🐛 0 | 🌐 C# | 📅 2025-02-18 `📆` <sup>`FOSS`</sup>
* `WDM` [DayDayUp](https://github.com/Fangjin98/daydayup) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2023-07-18 `📆` <sup>`FOSS`</sup>
* `WDM` [FluentTasks](https://github.com/javierferrersb/FluentTasks) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-03-11 <sup>`FOSS`</sup>
* `WDA` [ToDoManager](https://github.com/navi705/ToDoManager-WinUI3) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2023-03-22 `📆` <sup>`FOSS`</sup>
* `WD` [Openza Tasks](https://github.com/openza/tasks) ⭐ 3 | 🐛 1 | 🌐 C# | 📅 2026-08-09 <sup>`FOSS`</sup>
...
* `WDM` [Magpie](https://github.com/Blinue/Magpie) ⭐ 14,350 | 🐛 110 | 🌐 HLSL | 📅 2026-08-13 <sup>`FOSS`</sup>
* `WDM` [Mica For Everyone](https://github.com/MicaForEveryone/MicaForEveryone) ⭐ 5,191 | 🐛 181 | 🌐 C# | 📅 2026-07-17 <sup>`FOSS`</sup>
* `WD` [WinPaletter](https://github.com/Abdelrhman-AK/WinPaletter) ⭐ 1,856 | 🐛 6 | 🌐 C# | 📅 2026-07-26 <sup>`FOSS`</sup>
* `WD` [Rebound](https://github.com/IviriusCommunity/Rebound) ⭐ 845 | 🐛 13 | 🌐 C# | 📅 2026-08-11
* `WDM` [AccentColorizer](https://github.com/krlvm/AccentColorizer) ⭐ 514 | 🐛 21 | 🌐 C++ | 📅 2024-06-25 <sup>`FOSS`</sup>
* `WDM` [TranslucentSM](https://github.com/rounk-ctrl/TranslucentSM) ⚠️ Archived <sup>`FOSS`</sup> `❎`
* `WDM` [ChangeFolderIcon](https://github.com/YILING0013/ChangeFolderIcon) ⭐ 288 | 🐛 7 | 🌐 C# | 📅 2025-08-12 <sup>`FOSS`</sup>
* `WDA` [DeskBox](https://github.com/Tianyu199509/DeskBox) ⭐ 282 | 🐛 5 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [GyroShell](https://github.com/Pdawg-bytes/GyroShell) ⭐ 250 | 🐛 3 | 🌐 C# | 📅 2025-07-02 <sup>`FOSS`</sup>
* `WDM` [Startify](https://github.com/Lixkote/Startify) ⭐ 183 | 🐛 10 | 🌐 C# | 📅 2025-11-02
* `WDM` [Windows Custom Tile](https://github.com/fischldesu/WindowsCustomTile) ⭐ 102 | 🐛 2 | 🌐 C# | 📅 2026-07-07 <sup>`FOSS`</sup>
* `WD` [Folder Icon Painter](https://github.com/FolderPainter/FolderIconPainter) ⭐ 65 | 🐛 1 | 🌐 C# | 📅 2026-03-23 <sup>`FOSS`</sup>
* `WD` [YASB GUI](https://github.com/amnweb/yasb-gui) ⭐ 58 | 🐛 4 | 🌐 Python | 📅 2026-06-02 <sup>`FOSS`</sup>
* `WDM` [WinFocus](https://github.com/Albresky/WinFocus) ⭐ 22 | 🐛 1 | 🌐 C# | 📅 2025-03-31 <sup>`FOSS`</sup>
* `WDM` [Croak](https://github.com/MehranAkbarii/Croak) ⭐ 14 | 🐛 0 | 🌐 C++ | 📅 2023-07-22 <sup>`FOSS`</sup>
* `WD` [LegendBar](https://github.com/Baldev8910/LegendBar) ⭐ 12 | 🐛 0 | 🌐 C# | 📅 2026-07-07 <sup>`FOSS`</sup>
* `WDA` [Widgets Media](https://github.com/pepeizq/Widgets-Media) ⭐ 5 | 🐛 0 | 🌐 C# | 📅 2024-07-01 <sup>`FOSS`</sup>
* `WD` [Binggo Wallpapers](https://github.com/hippieZhou/BinggoWallpapers) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2026-08-13 <sup>`FOSS`</sup>
* `WD` [Crayon](https://github.com/xmha97/Crayon) ⭐ 3 | 🐛 1 | 🌐 Batchfile | 📅 2025-11-30 <sup>`FOSS`</sup>
* `WD` [Pulse](https://github.com/AverageCodeNerd/pulse) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2026-07-12 <sup>`FOSS`</sup>
* `WD` [FluentOBS](https://github.com/DarkForceFREEFIRE/FluentOBS) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2026-07-30 `🎨` <sup>`FOSS`</sup>
...
* `WDM` [MyerSplash](https://apps.microsoft.com/store/detail/myersplash-photos/9NBLGGH4VCSN)
...
* `WD` [FluentTaskScheduler](https://github.com/TRGamer-tech/FluentTaskScheduler) ⭐ 518 | 🐛 6 | 🌐 C# | 📅 2026-07-27 <sup>`FOSS`</sup>
* `WD` [StoryCAD](https://github.com/storybuilder-org/StoryCAD) ⭐ 27 | 🐛 25 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
...
* `WDM` [spoo.me](https://github.com/spoo-me/spooWASDK) ⭐ 5 | 🐛 0 | 🌐 C# | 📅 2024-02-23 <sup>`FOSS`</sup>
* `WD` [WinUI3 File Search Engine](https://github.com/israel-dryer/WinUI3-File-Search-Engine) ⭐ 5 | 🐛 0 | 🌐 C# | 📅 2023-01-21 <sup>`FOSS`</sup>
* `WDM` [Cipherflow](https://github.com/BradleyBao/Cipherflow) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2025-05-22 <sup>`FOSS`</sup>
* `WD` [StreamNumDeck](https://github.com/nikartom/StreamNumDeck) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2026-07-29 <sup>`FOSS`</sup>
* `WD` [LazyFish](https://github.com/XMuli/LazyFish) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2025-12-31 <sup>`FOSS`</sup>
* `WD` [openHAB](https://github.com/reyhard/openhab-win-app) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2026-07-26 <sup>`FOSS`</sup>
* `WDM` [SharpTimer](https://github.com/huizhiLLL/SharpTimer) ⭐ 1 | 🐛 2 | 🌐 C# | 📅 2026-07-17 <sup>`FOSS`</sup>
* `WDM` [BattleDex](https://github.com/merc1er/BattleDex) ⭐ 0 | 🐛 4 | 🌐 C# | 📅 2026-05-16 <sup>`FOSS`</sup>
* `WD` [Petapeta](https://github.com/daruyanagi/Petapeta) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Restless](https://github.com/silentq/Restless) ⭐ 0 | 🐛 1 | 🌐 C# | 📅 2026-05-16 <sup>`FOSS`</sup>
* `WD` [TouchSenderTablet](https://github.com/voltaney/TouchSenderTablet) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2025-04-06 <sup>`FOSS`</sup>
...
* `WDM` [Microsoft Journal](https://apps.microsoft.com/detail/9n318r854rhh) <sup>`FOSS`</sup>
...
* `WDM` [2FAGuard](https://github.com/timokoessler/2FAGuard) ⭐ 196 | 🐛 13 | 🌐 C# | 📅 2026-07-18 <sup>`FOSS`</sup>
...
* `WDM` [ClientWarden](https://github.com/Cherrytree56567/ClientWarden) ⭐ 62 | 🐛 0 | 🌐 C++ | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WM` [Pass11](https://github.com/LawOff/Pass11) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2023-09-28 <sup>`FOSS`</sup>
* `WDM` [Orayo](https://github.com/barkure/Orayo) ⭐ 22 | 🐛 1 | 🌐 C# | 📅 2026-08-13 <sup>`FOSS`</sup>
* `WDM` [EasePass](https://github.com/FrozenAssassine/EasePass) ⭐ 21 | 🐛 13 | 🌐 C# | 📅 2026-05-06 <sup>`FOSS`</sup>
* `WDM` [Honeypot](https://github.com/sh0ckj0ckey/Honeypot) ⭐ 7 | 🐛 1 | 🌐 C# | 📅 2026-08-04 <sup>`FOSS`</sup>
* `WDM` [Cyber Vault](https://github.com/affan-ch/Cyber-Vault-Desktop-Offline) ⭐ 2 | 🐛 7 | 🌐 C# | 📅 2024-09-25 <sup>`FOSS`</sup>
...
* `WD` [Proton VPN](https://github.com/ProtonVPN/win-app) ⭐ 2,437 | 🐛 66 | 🌐 C# | 📅 2026-07-27 <sup>`FOSS`</sup>
* `WD` [Atoll VPN](https://github.com/kaoshipaws/atollvpn) ⭐ 11 | 🐛 0 | 📅 2026-07-11

### Other

* `WD` [XrayUI](https://github.com/PhoenixNil/XrayUI-dev) ⭐ 579 | 🐛 5 | 🌐 C# | 📅 2026-08-07 <sup>`FOSS`</sup>
* `WD` [Swell Proxy](https://github.com/yaog6700-bit/Swell-Proxy) ⭐ 433 | 🐛 3 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [SecureFolderFS](https://github.com/securefolderfs-community/SecureFolderFS) ⭐ 284 | 🐛 7 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
...
* `WDM` [Unicord](https://github.com/UnicordDev/Unicord) ⭐ 407 | 🐛 51 | 🌐 C# | 📅 2026-01-18 `📆` <sup>`FOSS`</sup>
...
* `WD` [Discord-11](https://github.com/zuzumi-f/Discord-11) ⭐ 135 | 🐛 4 | 🌐 CSS | 📅 2024-07-08 `🎨` <sup>`FOSS`</sup>
...
* `WDM` [Carpeddit](https://github.com/itsWindows11/Carpeddit) ⭐ 90 | 🐛 3 | 🌐 C# | 📅 2023-07-01 `❎`
* `WD` [Fluentreddit](https://github.com/tobyisawesome/fluentreddit/tree/main) ⭐ 31 | 🐛 3 | 🌐 CSS | 📅 2023-08-17 `🎨` <sup>`FOSS`</sup>
...
* `WDM` [Windows Calculator](https://github.com/Microsoft/calculator) ⭐ 31,013 | 🐛 466 | 🌐 C++ | 📅 2026-08-05 <sup>`FOSS`</sup>
* `WDM` [Lamina](https://github.com/Chill-Astro/Lamina-Calculator) ⭐ 20 | 🐛 0 | 🌐 C# | 📅 2026-06-14 <sup>`FOSS`</sup>
* `WD` [Calculator](https://github.com/fanioz/calculator) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-01-01 <sup>`FOSS`</sup>
* `WD` [Simple Calculator](https://github.com/cechout/simple-calculator) ⭐ 0 | 🐛 4 | 🌐 C# | 📅 2026-07-06 <sup>`FOSS`</sup>
* `WDM` [Eagle-Calculator](https://apps.microsoft.com/detail/Eagle-Calculator/9MX92VG2G7NS)
...
* `WD` [Fluent HwInfo](https://github.com/cechout/fluent-sensors) ⭐ 4 | 🐛 7 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WD` [VRAMonitor](https://github.com/jin6yang/VRAMonitor) ⭐ 2 | 🐛 2 | 🌐 C# | 📅 2026-03-30 <sup>`FOSS`</sup>
* `WDM` [Suspension](https://github.com/Tech5G5G/Suspension) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2025-10-07 <sup>`FOSS`</sup>
* `WDM` [Vitals](https://github.com/Frenchouioui/Vitals) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2026-07-08 <sup>`FOSS`</sup>
...
* `WDM` [Win11Debloat](https://github.com/Raphire/Win11Debloat) ⭐ 55,355 | 🐛 34 | 🌐 PowerShell | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WD` [Winhance](https://github.com/memstechtips/Winhance) ⭐ 12,460 | 🐛 61 | 🌐 C# | 📅 2026-08-13 <sup>`FOSS`</sup>
* `WDM` [optimizerDuck](https://github.com/itsfatduck/optimizerDuck) ⭐ 8,303 | 🐛 16 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [FluentCleaner](https://github.com/builtbybel/FluentCleaner) ⭐ 5,187 | 🐛 10 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [EvolveOS Optimizer](https://github.com/EvolveOS-Software/EvolveOS_Optimizer_V3.0) ⭐ 10 | 🐛 0 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
...
* `WDM` [Flint](https://github.com/sh0ckj0ckey/Flint) ⭐ 34 | 🐛 4 | 🌐 C# | 📅 2026-03-17 <sup>`FOSS`</sup>
* `WDM` [Transhef](https://github.com/shfrlabs/Transhef) ⚠️ Archived <sup>`FOSS`</sup> `❎`
* `WDM` [WordWeaver](https://github.com/itsWindows11/WordWeaver) ⭐ 18 | 🐛 0 | 🌐 C# | 📅 2023-12-02 <sup>`FOSS`</sup>
* `WD` [Auto Translate Clipboard](https://github.com/hasoftware/Auto-Translate-Clipboard) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2026-07-10 <sup>`FOSS`</sup>
...
* `WDM` [NanaZip](https://github.com/M2Team/NanaZip) ⭐ 15,066 | 🐛 370 | 🌐 C++ | 📅 2026-08-06
* `WD` [Everything Toolbar](https://github.com/srwi/EverythingToolbar) ⭐ 14,553 | 🐛 35 | 🌐 C | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WDM` [RyTuneX](https://github.com/rayenghanmi/RyTuneX) ⭐ 5,330 | 🐛 0 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Text-Grab](https://github.com/TheJoeFin/Text-Grab) ⭐ 4,928 | 🐛 60 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WD` [Tuba Toolbox](https://github.com/luolangaga/tubatools) ⭐ 2,254 | 🐛 48 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [Energy Star X](https://github.com/JasonWei512/EnergyStarX) ⭐ 1,216 | 🐛 32 | 🌐 C# | 📅 2026-02-08 <sup>`FOSS`</sup>
* `WDM` [MagicPods](https://github.com/steam3d/MagicPods-Windows) ⭐ 847 | 🐛 40 | 📅 2025-07-06 <sup>`FOSS`</sup>
* `WDM` [FastCopy](https://github.com/HO-COOH/FastCopy) ⭐ 633 | 🐛 21 | 🌐 C++ | 📅 2026-08-08 <sup>`FOSS`</sup>
* `WDM` [fHash](https://github.com/sunjw/fhash) ⭐ 451 | 🐛 0 | 🌐 C++ | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WDM` [EasyTidy](https://github.com/EasyTidy/EasyTidy) ⭐ 322 | 🐛 3 | 🌐 C# | 📅 2026-08-09 <sup>`FOSS`</sup>
* `WDM` [barcodrod.io](https://github.com/MarkHopper24/barcodrod.io) ⭐ 222 | 🐛 1 | 🌐 C# | 📅 2026-07-30 <sup>`FOSS`</sup>
* `WDM` [MyPhone](https://github.com/BestOwl/MyPhone) ⭐ 218 | 🐛 15 | 🌐 C# | 📅 2022-12-22 <sup>`FOSS`</sup>
* `WDA` [Awqat-Salaat](https://github.com/Khiro95/Awqat-Salaat) ⭐ 215 | 🐛 13 | 🌐 C# | 📅 2026-06-11 <sup>`FOSS`</sup>
* `WDM` [LauncherX](https://github.com/Apollo199999999/LauncherX) ⭐ 188 | 🐛 6 | 🌐 C# | 📅 2026-01-07 <sup>`FOSS`</sup>
* `WDM` [NanaGet](https://github.com/M2Team/NanaGet) ⭐ 180 | 🐛 5 | 🌐 C++ | 📅 2026-03-14
* `WDM` [Registry Editor Valley](https://github.com/0x5bfa/RegistryEditor) ⭐ 143 | 🐛 3 | 🌐 C# | 📅 2026-03-16 <sup>`FOSS`</sup>
* `WDM` [SimpleList](https://github.com/aiguoli/SimpleList) ⭐ 141 | 🐛 4 | 🌐 C# | 📅 2026-07-19 <sup>`FOSS`</sup>
* `WDM` [Simple QR Code Maker](https://github.com/TheJoeFin/Simple-QR-Code-Maker) ⭐ 116 | 🐛 8 | 🌐 C# | 📅 2026-08-01 `📆` <sup>`FOSS`</sup>
* `WDM` [Aura Click](https://github.com/ryanlua/auraclick) ⭐ 107 | 🐛 8 | 🌐 C# | 📅 2026-07-20 <sup>`FOSS`</sup>
* `WDM` [IRCameraView](https://github.com/Iemand005/IRCameraView) ⭐ 94 | 🐛 7 | 🌐 C# | 📅 2026-02-15 <sup>`FOSS`</sup>
* `WDM` [Amethyst Releases](https://github.com/KinectToVR/Amethyst-Releases) ⭐ 87 | 🐛 3 | 🌐 C# | 📅 2026-04-02 <sup>`FOSS`</sup>
* `WD` [HashTool](https://github.com/KiyanYang/DotVast.HashTool.WinUI) ⭐ 87 | 🐛 1 | 🌐 C# | 📅 2025-09-19 <sup>`FOSS`</sup>
* `WD` [Tiny Clips](https://github.com/jamesmontemagno/tiny-clips) ⭐ 80 | 🐛 4 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WD` [WSAppBak](https://github.com/MadCkull/WSAppBak) ⭐ 74 | 🐛 1 | 🌐 C# | 📅 2026-07-28 <sup>`FOSS`</sup>
* `WDM` [CryptoTracker](https://github.com/ismaelestalayo/CryptoTracker) ⭐ 69 | 🐛 8 | 🌐 C# | 📅 2025-01-25 <sup>`FOSS`</sup>
* `WDM` [AutoOS](https://github.com/tinodin/AutoOS) ⭐ 59 | 🐛 0 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WDM` [FolderRewind](https://github.com/Leafuke/FolderRewind) ⭐ 55 | 🐛 5 | 🌐 C# | 📅 2026-08-06 <sup>`FOSS`</sup>
* `WDM` [Fontager](https://github.com/ysfemreAlbyrk/Fontager) ⭐ 47 | 🐛 2 | 🌐 C# | 📅 2026-05-26 <sup>`FOSS`</sup>
* `WDM` [SUBSTitute](https://github.com/sungaila/SUBSTitute) ⭐ 32 | 🐛 0 | 🌐 C# | 📅 2026-05-08 <sup>`FOSS`</sup>
* `WDM` [Remote Toolbox](https://github.com/sixiaolong1117/WinWoL) ⭐ 31 | 🐛 1 | 🌐 C# | 📅 2026-07-05 <sup>`FOSS`</sup>
* `WD` [AudioPlaybackConnector2](https://github.com/N0ahTM/AudioPlaybackConnector2) ⭐ 30 | 🐛 2 | 🌐 C++ | 📅 2026-07-25 <sup>`FOSS`</sup>
* `WD` [FlowEncode](https://github.com/frankie1024/FlowEncode) ⭐ 28 | 🐛 0 | 🌐 C# | 📅 2026-08-01 <sup>`FOSS`</sup>
* `WDA` [Rufus Next](https://github.com/rasyidf/rufus-next) ⭐ 26 | 🐛 1 | 🌐 C# | 📅 2025-02-23 `📆` <sup>`FOSS`</sup>
* `WDM` [Universal Analog Input](https://github.com/Ritonton/UniversalAnalogInput) ⭐ 26 | 🐛 1 | 🌐 C# | 📅 2026-05-27 <sup>`FOSS`</sup>
...
* `WDM` [Fluentver](https://github.com/Tech5G5G/Fluentver) ⭐ 23 | 🐛 1 | 🌐 C# | 📅 2026-08-12 <sup>`FOSS`</sup>
* `WD` [Ping Legacy](https://github.com/avikeid2007/Ping-Legacy) ⭐ 23 | 🐛 0 | 🌐 C# | 📅 2026-02-19 <sup>`FOSS`</sup>
* `WDM` [Conscript](https://github.com/sh0ckj0ckey/Conscripts) ⭐ 17 | 🐛 0 | 🌐 C# | 📅 2026-06-20 <sup>`FOSS`</sup>
* `WD` [Trowser](https://github.com/TheJoeFin/trowser) ⭐ 17 | 🐛 0 | 🌐 C# | 📅 2026-07-07 <sup>`FOSS`</sup>
...
* `WDM` [Jump List Manager](https://github.com/0x5bfa/JumpListManager) ⭐ 13 | 🐛 1 | 🌐 C# | 📅 2026-03-15 <sup>`FOSS`</sup>
* `WD` [Task Scheduler Studio](https://github.com/MarkHopper24/Task-Scheduler-Studio) ⭐ 13 | 🐛 0 | 🌐 C# | 📅 2026-08-06 <sup>`FOSS`</sup>
* `WDM` [Utils for Nearby Sharing](https://github.com/nearby-sharing/windows) ⭐ 11 | 🐛 1 | 🌐 C# | 📅 2026-03-29 <sup>`FOSS`</sup>
* `WDM` [inputor](https://github.com/shiquda/inputor) ⭐ 10 | 🐛 1 | 🌐 C# | 📅 2026-07-30 <sup>`FOSS`</sup>
...
* `WD` [Bucket](https://github.com/aungkokomm/Bucket) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2026-07-03 <sup>`FOSS`</sup>
* `WD` [LANConnect](https://github.com/WinUI-Dev/LANConnect) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2024-11-17 <sup>`FOSS`</sup>
* `WDM` [LTOG](https://github.com/rlaphoenix/LTOG) ⭐ 7 | 🐛 2 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WD` [AT Installer](https://github.com/airtaxi/AT-Installer) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2026-07-24 <sup>`FOSS`</sup>
* `WDM` [Automated Menu Ordering System](https://github.com/abdxdev/AMOS) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2026-03-24 `📆 Planned` <sup>`FOSS`</sup>
* `WDM` [OmenFlow](https://github.com/yunusemreyl/OmenFlow) ⭐ 5 | 🐛 0 | 🌐 C# | 📅 2026-07-15 <sup>`FOSS`</sup>
* `WD` [EM Hasher](https://github.com/enda-mullally/EMHasher) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-08-13 <sup>`FOSS`</sup>
* `WDM` [OpenFuryKMS](https://github.com/KevGreenwood/OpenFuryKMS) ⚠️ Archived <sup>`FOSS`</sup> `❎`
...
* `WD` [Snaply](https://github.com/P4suta/Snaply) ⭐ 3 | 🐛 4 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WD` [Deckle](https://github.com/louisfifre/deckle) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WD` [Dusk Control](https://github.com/stabldev/dusk-control) ⭐ 2 | 🐛 2 | 🌐 C# | 📅 2026-07-18 <sup>`FOSS`</sup>
* `WD` [LinkTo](https://github.com/abevol/LinkTo) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-03-30 <sup>`FOSS`</sup>
* `WDA` [MouseClicker](https://github.com/kavoye/MouseClicker) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2026-07-28 <sup>`FOSS`</sup>
* `WD` [Notification Reader](https://github.com/Sudan-Dhungana/NotificationReader-WinUIApp) ⭐ 2 | 🐛 0 | 🌐 Batchfile | 📅 2026-04-23 <sup>`FOSS`</sup>
* `WD` [RepoBackup](https://github.com/GuildOfCalamity/RepoBackup) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2025-07-20 `📆` <sup>`FOSS`</sup>
* `WD` [SmartLinker](https://github.com/theFASTER-UNiTY/SmartLinker) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WDM` [Snipdeck](https://github.com/StuartMeeks/Snipdeck) ⭐ 2 | 🐛 3 | 🌐 C# | 📅 2026-07-01 <sup>`FOSS`</sup>
* `WD` [ClipCore](https://github.com/Kleaopsy/ClipCore) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2025-11-01 `📆 Planned` <sup>`FOSS`</sup>
* `WD` [D3D12LookDevPTWinUI](https://github.com/shaderjp/D3D12LookDevPTWinUI3) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-08-08 `📆 Planned` <sup>`FOSS`</sup>
* `WD` [Dell PowerEdge R730xd Fan Control Center](https://github.com/mason369/dell-poweredge-r730xd-fan-control) ⭐ 1 | 🐛 1 | 🌐 C# | 📅 2026-08-09 <sup>`FOSS`</sup>
* `WD` [Dialed](https://github.com/DavideClemente/Dialed) ⭐ 1 | 🐛 7 | 🌐 C# | 📅 2026-07-30 <sup>`FOSS`</sup>
* `WD` [EtherealScepter](https://github.com/Eternity-boundary/EtherealScepter) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-07-26 <sup>`FOSS`</sup>
* `WD` [ewcalc](https://github.com/OldCrow/ewcalc) ⭐ 1 | 🐛 1 | 🌐 C++ | 📅 2026-08-07 <sup>`FOSS`</sup>
* `WDM` [Glimmer](https://github.com/danishm/glimmer) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2025-11-24 <sup>`FOSS`</sup>
* `WDM` [Google Photos Takeout Organizer](https://github.com/itielbru/gphotos-takeout-organizer) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2026-07-23 <sup>`FOSS`</sup>
* `WDM` [Hostbeat Client](https://github.com/ruben69695/hostbeat-win) ⭐ 1 | 🐛 2 | 🌐 C# | 📅 2023-05-21 <sup>`FOSS`</sup>
* `WD` [PowerModeSlider](https://github.com/giulioungaretti/PowerModeSlider) ⭐ 1 | 🐛 2 | 🌐 C# | 📅 2026-06-23 <sup>`FOSS`</sup>
* `WD` [WingetUSoft](https://github.com/xfiberex/WingetUSoft) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2026-07-21 <sup>`FOSS`</sup>
...
* `WD` [CopyPaste](https://github.com/EddizEge/CopyPaste) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-07-23 <sup>`FOSS`</sup>
* `WD` [DispEx](https://github.com/AlexG-4W/DispEx) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-06-19 <sup>`FOSS`</sup>
* `WDM` [Hylian Grimoire](https://github.com/Vrilya/Hylian-Grimoire) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-06-18 <sup>`FOSS`</sup>
* `WD` [KeepPressing](https://github.com/P4suta/keep-pressing) ⭐ 0 | 🐛 2 | 🌐 C# | 📅 2026-08-10 <sup>`FOSS`</sup>
* `WDM` [KeyCleanr](https://github.com/jesussocool/KeyCleanr) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-04-27 <sup>`FOSS`</sup>
* `WD` [Lyra](https://github.com/Turtlepaw/lyra) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-03-20 `📆 Planned` <sup>`FOSS`</sup>
* `WDM` [MailTrayNotifier](https://github.com/jongcheol-pak/MailTrayNotifier) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-06-23 <sup>`FOSS`</sup>
* `WD` [PicSelect](https://github.com/Rana-Faraz/pic-select) ⭐ 0 | 🐛 2 | 🌐 C# | 📅 2026-03-26 <sup>`FOSS`</sup>
* `WD` [RunDialog](https://github.com/Dekrate/RunDialog) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-05-02 <sup>`FOSS`</sup>
* `WDM` [Simple Number Converter](https://github.com/B3W/SimpleNumberConverter) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2025-08-05 <sup>`FOSS`</sup>
* `WDM` [TrueRotate](https://github.com/BK927/true-rotate) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-07-03 <sup>`FOSS`</sup>
...
* `WD` [BuhoSleep](https://apps.microsoft.com/detail/9pfhwns1fp82)
...
* `WDA` [Media - WidBar Widget](https://apps.microsoft.com/detail/9nbvchs7jr0c)
* `WD` [Media Converter WinUI](https://apps.microsoft.com/detail/9p0zf7h76r6s)
...
* `WDM` [TwinTrace - Duplicate File Remover](https://apps.microsoft.com/detail/9nmnn12vj1h8)
...
* `WDM` [FluentWeather](https://github.com/Gabboxl/FluentWeather) ⭐ 332 | 🐛 19 | 🌐 C# | 📅 2026-07-22 <sup>`FOSS`</sup>
* `WDM` [Skyline Weather](https://github.com/zxbmmmmmmmmm/SkylineWeather) ⭐ 166 | 🐛 16 | 🌐 C# | 📅 2026-08-01 <sup>`FOSS`</sup>
...
* `WDM` [Microsoft PowerToys](https://github.com/microsoft/PowerToys) ⭐ 137,704 | 🐛 7,446 | 🌐 C | 📅 2026-08-13 <sup>`FOSS`</sup>
...
* `WDA` [Windows Terminal](https://apps.microsoft.com/store/detail/windows-terminal/9N0DX20HK701) <sup>`FOSS`</sup>

<sub>[📑 Table Of Contents](#-table-of-contents)</sub>

## 📖 Miscellaneous

* `WDM` [RailGo-WinUI](https://github.com/RailGoApps/RailGo-WinUI) ⭐ 136 | 🐛 2 | 🌐 C# | 📅 2026-07-24 <sup>`FOSS`</sup>
* `WDM` [Inventory](https://github.com/LeftTwixWand/eShopOnWinUI) ⭐ 95 | 🐛 25 | 🌐 C# | 📅 2026-07-20 <sup>`FOSS`</sup>
* `WDM` [ForzaTech Studio](https://github.com/D3FEKT/ForzaTechStudio) ⭐ 54 | 🐛 2 | 🌐 C# | 📅 2026-06-26 <sup>`FOSS`</sup>
* `WDM` [PSX Master](https://github.com/ghost1372/PSXMaster) ⭐ 33 | 🐛 0 | 🌐 C# | 📅 2026-01-05
* `WDM` [FoodDesire](https://github.com/haritha99ch/FoodDesire) ⭐ 29 | 🐛 0 | 🌐 C# | 📅 2024-03-16 <sup>`FOSS`</sup>
* `WDM` [Al-Anvar](https://github.com/ghost1372/Al-Anvar) ⭐ 17 | 🐛 0 | 🌐 C# | 📅 2026-07-14 <sup>`FOSS`</sup>
* `WDM` [WDCable](https://github.com/jingcjie/WDCableWUI) ⭐ 14 | 🐛 0 | 🌐 C# | 📅 2026-06-23 <sup>`FOSS`</sup>
* `WD` [Library Management System](https://github.com/Diyari-Kurdi/Library-Management-System) ⚠️ Archived `📆` <sup>`FOSS`</sup> `❎`
* `WD` [BattleAssistant](https://github.com/ArchieHill/BattleAssistant) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2023-08-31 <sup>`FOSS`</sup>
* `WD` [Dream Unreal Manager](https://github.com/TypeDreamMoon/DreamUnrealManager) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-07-07 <sup>`FOSS`</sup>
* `WD` [MitamatchOperations](https://github.com/loliGothicK/MitamatchOperations) ⭐ 4 | 🐛 11 | 🌐 C# | 📅 2026-08-11 <sup>`FOSS`</sup>
* `WDM` [MyTel-U Launcher](https://github.com/GID0317/MyTel-U_WinUI3) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-05-30 <sup>`FOSS`</sup>
* `WD` [Maze-Generator](https://github.com/atslughorn/Maze-Generator) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2024-07-17 <sup>`FOSS`</sup>
* `WD` [RiskFlow](https://github.com/InstaZDLL/RiskFlow) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2026-05-31 <sup>`FOSS`</sup>
* `WD` [DiscordFileMasterV2](https://github.com/Shailosingh/DiscordFileMasterV2) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2022-12-26 <sup>`FOSS`</sup>
* `WD` [Arrival](https://github.com/thatweirdbush/arrival) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2025-03-30 <sup>`FOSS`</sup>
* `WD` [Nafer](https://github.com/VueST/nafer-frontend) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-04-18 <sup>`FOSS`</sup>
